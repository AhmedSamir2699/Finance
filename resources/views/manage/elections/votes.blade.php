                ...
                <div class="shadow-md overflow-hidden border-b border-gray-200 sm:rounded-lg bg-white">
                    <div class="px-6 py-4">
                        <h2 class="text-2xl font-semibold text-gray-700">
                            {{ __('manage.elections.results.votes_headline', ['name' => $election->name]) }}
                            <small>
                        ...
                        <div class="flex flex-row justify-between gap-3">
                            ...
                            <p class="text-gray-500 mt-1">
                                {{ __('manage.elections.results.total_votes', ['total' => $election->votes->count()]) }}
                            ...
                            <thead class="bg-gray-50">
                                <tr>
                                    <th
                                        ...
                                        {{ __('manage.elections.results.voter') }}
                                    </th>
                                    <th
                                        class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    ...
                                    <th
                                        class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        {{ __('manage.elections.results.timestamp') }}
                                    </th>
                                </tr>
                            </thead>
