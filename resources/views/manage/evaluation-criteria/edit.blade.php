        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h2 class="text-2xl font-semibold mb-6">{{ __('manage.evaluation_criteria.edit.headline') }}</h2>

                    <form action="{{ route('manage.evaluation-criteria.update', $criteria) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" 
                                          ...
                                          rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                          placeholder="{{ __('manage.evaluation_criteria.form.description_placeholder') }}">{{ old('description', $criteria->description) }}</textarea>
                                @error('description')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       name="min_value" 
                                       id="min_value" 
                                       value="{{ old('min_value', $criteria->min_value) }}"
                                       min="0"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                       required>
                                @error('min_value')
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       name="max_value" 
                                       id="max_value" 
                                       value="{{ old('max_value', $criteria->max_value) }}"
                                       min="1"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                       required>
                                @error('max_value')
                        ...
                        <div class="flex justify-end mt-6">
                            ...
                            <button type="submit" 
                                ...
                                {{ __('manage.evaluation_criteria.form.update') }}
                            </button>
                        </div>
                    </form>
                </div>
