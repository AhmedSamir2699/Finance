<x-app-layout>
    ...
    <div class="container mt-4 mx-auto">
        <div class="flex flex-col bg-white py-2 px-4 rounded-md shadow-md border">
            ...
            <form action="{{ route('tasks.submit.store', $task->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="flex flex-col gap-4 mt-4">
                    <div class="flex flex-col gap-2">
                        <label for="description" class="text-gray-700">{{ __('tasks.submit.description') }}</label>
                    ...
                    <div class="flex flex-col gap-2">
                        <label for="attachment" class="text-gray-700">{{ __('tasks.submit.attachments') }}</label>
