<div class="p-4 space-y-4">
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="rounded bg-blue-600 text-white px-4 py-2 hover:bg-blue-700 transition" href="{{route('expense-categories.create')}}">
    ...
    <div class="overflow-auto rounded border">
        <table class="min-w-full text-sm text-right">
            <thead class="bg-gray-100 text-xs uppercase text-gray-600">
                <tr>
                    <th class="px-4 py-2">{{ __('cruds.expenseCategory.fields.id') }}</th>
                    <th class="px-4 py-2">{{ __('cruds.expenseCategory.fields.name') }}</th>
    ...
    <div>{{ $expenseCategories->links() }}</div>
</div>
