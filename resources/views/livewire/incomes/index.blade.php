<div class="p-4 space-y-4">
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="rounded bg-blue-600 text-white px-4 py-2 hover:bg-blue-700 transition" href="{{route('incomes.create')}}">
        ...
        <table class="min-w-full text-sm text-right">
            <thead class="bg-gray-100 text-xs uppercase text-gray-600">
                <tr>
                    ...
                    <th class="px-4 py-2">{{ __('cruds.income.fields.finance_item') }}</th>
            ...
            <tbody>
                @forelse($incomes as $income)
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2">{{ $income->finance_item->name ?? '' }}</td>
