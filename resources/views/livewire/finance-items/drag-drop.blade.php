    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    @include('admin.financeItems.partials.create', ['allItems' => $allItems])
                </div>
            </div>
        </div>
                    ...
                    <div class="dd" id="nestable">
                        <ol class="dd-list">
                            @foreach ($items as $item)
                                @include('admin.financeItems.partials.item', ['item' => $item])
                            @endforeach
                        </ol>
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#nestable').on('change', function() {
                    ...
                    $.post('{{ route('finance-items.reorder') }}', {
                        _token: '{{ csrf_token() }}',
                        data: data
                    });
                });
