                ...
                <div class="col-span-2">
                    ...
                    <select name="income_category_id" id="income_category_id"
                        ...
                        @foreach($income_categories as $id => $entry)
                            <option value="{{ $id }}" {{ old('income_category_id',$income->income_category_id) == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-span-2">
                    ...
                    <select name="finance_item_id" id="finance_item_id"
                        ...
                        @foreach($finance_items as $id => $entry)
                            <option value="{{ $id }}" {{ old('finance_item_id',$income->finance_item_id) == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                    @error('finance_item')
                        <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
