<x-app-layout>
    ...
    <div class="container mt-4 mx-auto">
        {{-- <div class="bg-white py-2 px-4 rounded-md shadow-md border" x-data="{ 
            ...
            <form method="POST" action="{{ route('expense-categories.update',['expenseCategory'=>$expenseCategory]) }}" enctype="multipart/form-data"
    ...
    <div class="col-span-2">
        ...
        @enderror
        <p class="text-xs text-gray-500 mt-1">{{ trans('cruds.expenseCategory.fields.name_helper') }}</p>
    </div>
