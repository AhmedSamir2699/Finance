<x-app-layout>
    ...
    <div class="container mt-4 mx-auto">
        ...
        <form method="POST" action="{{ route('finance-items.store') }}" enctype="multipart/form-data"
            ...
            <div class="col-span-1">
                ...
                <input type="text" name="name" id="name" step="0.01" value="{{ old('name', '') }}"
            ...
            <div class="col-span-1">
                <label for="amount" class="block text-sm font-medium text-slate-700 py-2">
                    {{ trans('cruds.financeItem.fields.amount') }} 
                </label>
                <input type="number" name="amount" id="amount" step="0.01" value="{{ old('amount', 0) }}"
