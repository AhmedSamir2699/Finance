...
class ExpenseReportController extends Controller
{
    public function index()
    {
        ...
        $parentsWithChildren = FinanceItem::with('children.children') // preload children
        ->whereNull('parent_id')
        ->get();
$leafItems = FinanceItem::with('parent.parent') // lazy parent chain
    ->doesntHave('children')                   // leaf only
    ->get();
