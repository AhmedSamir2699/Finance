...
class IncomeCategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        $breadcrumbs = [
            ...
            route('income-categories') => __('breadcrumbs.tasks.index'),
            route('income-categories.create')
        ];
        return view('admin.incomeCategories.create', compact('breadcrumbs'));
    }
    ...
    public function edit(IncomeCategory $incomeCategory)
    {
        ...
        return view('admin.incomeCategories.edit', compact('incomeCategory', 'breadcrumbs'));
    }
    ...
    public function show(IncomeCategory $incomeCategory)
    {
        ...
        return view('incomeCategories.show', compact('incomeCategory'));
    }
